...
pub async fn controller(
    ...
    use taskios_domain::{
        errors::use_cases::projects::retrieve::Error,
        params::use_cases::project::retrieve::Params,
    };
    ...
    return match ProjectsUseCase::retrieve(&params, _authios_sdk.into_inner(), &mut *database_client).await {
